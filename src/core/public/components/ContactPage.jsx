      ...
      <section className="pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="bg-white p-8 rounded-xl shadow-sm">
          ...
          <div className="rounded-lg overflow-hidden h-96">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3564.5286853763693!2d85.91967277608675!3d26.744697076735846!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjbCsDQ0JzQwLjkiTiA4NcKwNTUnMjAuMSJF!5e0!3m2!1sen!2sus!4v1714818772774!5m2!1sen!2sus" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen="" 
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              We're conveniently located in Janakpur, with easy access via public transportation.
              <br/>
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">We aim to respond to all email inquiries within 24 hours during business days. For urgent matters, please call our main phone number.</p>
            </div>
